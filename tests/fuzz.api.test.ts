        ...
        fc.oneof(
          ...
          fc.record({
            ...
            action: fc.oneof(
              ...
              fc.constant({}),
              fc.record({
                kind: fc.constant('prompt'),
                prompt: fc.option(fc.string(), { nil: undefined }),
                promptFile: fc.option(fc.string(), { nil: undefined }),
                engine: fc.option(fc.constantFrom('copilot', 'agency', 'bad-engine'), { nil: undefined }),
                sessionId: fc.option(fc.string(), { nil: undefined }),
                reuseSession: fc.option(fc.boolean(), { nil: undefined }),
              }),
            ),
          }),
